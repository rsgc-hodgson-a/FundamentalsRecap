...
for y in stride(from: 0, through: 500, by: 220){
    ...
    for x in stride(from: 0, through: 500, by: 64){
        ...
        canvas.fillColor=Color.red
        canvas.drawEllipse(centreX: x, centreY: 175+y, width: 56, height: 56)
        
        canvas.fillColor=Color.blue
        canvas.drawEllipse(centreX: x, centreY: 175+y, width: 40, height: 40)
        
        canvas.fillColor=Color.black
        canvas.drawEllipse(centreX: x, centreY: 175+y, width: 24, height: 24)
        
        canvas.fillColor=Color.white
        canvas.drawEllipse(centreX: x, centreY: 175+y, width: 8, height: 8)
    }
    ...
    for x in stride(from: 32, through: 500, by: 64){
        ...
        canvas.fillColor=Color.black
        canvas.drawEllipse(centreX: x, centreY: 220+y, width: 56, height: 56)
        
        canvas.fillColor=Color.blue
        canvas.drawEllipse(centreX: x, centreY: 220+y, width: 40, height: 40)
        
        canvas.fillColor=Color.red
        canvas.drawEllipse(centreX: x, centreY: 220+y, width: 24, height: 24)
        
        canvas.fillColor=Color.white
        canvas.drawEllipse(centreX: x, centreY: 220+y, width: 8, height: 8)
    }
    //Line loop
    for x in stride(from: 0, through: 500, by: 64){
        canvas.lineColor=Color.white
